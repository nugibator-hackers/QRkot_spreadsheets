...
Revision ID: 3fdaa95bee25
Revises: 
Create Date: 2024-05-10 18:00:43.252931
...
def upgrade():
    ...
    with op.batch_alter_table('charityproject', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_charityproject_close_date'),
                              ['close_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_charityproject_create_date'),
                              ['create_date'], unique=False)
    ...
    with op.batch_alter_table('donation', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_donation_close_date'),
                              ['close_date'], unique=False)
        batch_op.create_index(batch_op.f('ix_donation_create_date'),
                              ['create_date'], unique=False)
